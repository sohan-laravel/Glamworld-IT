...
<div class="container mt-3">
    <div class="card">
        <div class="card-header">
            ...
            <h3 class="card-title">CTA Edit</h3>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.cta.update', $cta->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" value="{{ $cta->name }}" placeholder="Enter Name">
                </div>

                <div class="form-group">
                    <label for="description">Description</label>
                    <textarea name="description" id="mytextarea" cols="30" rows="10">{{ $cta->description }}</textarea>
                </div>
