           ...
           <tr>
               ...
               <td>
                   @if($row->image_one != null)
                        <img src="{{  asset('frontend/images/productImage/' .$row->image_one) }}" style="width: 100px;" class="img-fluid" alt="{{ $row->name }}" >
                    @else
                        —
                    @endif
               </td>
               <td>
                   @if($row->image_two != null)
                        <img src="{{  asset('frontend/images/productLinkImage/' .$row->image_two) }}" style="width: 100px;" class="img-fluid" alt="{{ $row->name }}" >
                    @else
                        —
                    @endif
               </td>
