...
Route::group(['namespace' => 'Backend', 'prefix' => 'admin', 'middleware' => 'auth:admin'], function () {
    ...
    Route::resource('index', 'indexController', ['names' => 'admin.index']);

    //Admin index

    Route::resource('newsletter', 'NewsletterController', ['names' => 'admin.newsletter']);
    ...
    Route::resource('service', 'ServiceController', ['names' => 'admin.service']);
    Route::post('service/inactive', 'ServiceController@inactive')->name('admin.service.inactive');

    //Admin CTA

    Route::resource('cta', 'CtaController', ['names' => 'admin.cta']);
    Route::post('cta/inactive', 'CtaController@inactive')->name('admin.cta.inactive');
...
Route::group(['namespace' => 'Frontend'], function () {
    ...
    Route::resource('subscribe', 'SubscribeController', ['names' => 'subscribe']);
